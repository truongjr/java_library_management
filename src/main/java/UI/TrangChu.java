...
public class TrangChu extends javax.swing.JFrame {
    ...
    private void loadValueTable(String prefixName){
        ...
        try {
            String query = "SELECT MaDocGia, Ho, Ten, GioiTinh, NgaySinh, Email, SDT FROM dbo.DOCGIA WHERE Ho + ' ' + Ten LIKE '" + prefixName + "%'";
...
//        System.out.println(date);
    ...
    private void chinhSuaSachButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chinhSuaSachButtonActionPerformed
        if(selectedRowIndex >= 0){
